...
<html lang="en" data-bs-theme="light">
  <head>
    ...
    <!-- TinyMCE -->
    <script src="<?= base_url('assets/modules/tinymce/tinymce.min.js') ?>" referrerpolicy="origin"></script>
    <script>
      tinymce.init({
    ...
    <main class="content">
      ...
      <div class="d-flex justify-content-between">
        <section class="title-content p-3">
          <h3><?= $title ?></h3>
          <p>Check documentation  <a href="https://www.tiny.cloud/docs/tinymce/6/" target="_blank">TinyMCE</a></p>
        </section>
      ...
      <section class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">TinyMCE Example</div>
              <div class="card-body">
                <textarea id="default">Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati quasi vitae quidem earum qui? Voluptatem dolores eveniet libero doloribus praesentium delectus alias quidem, architecto perspiciatis temporibus dolorum magnam eos recusandae blanditiis vitae totam enim nisi dolore perferendis numquam nesciunt, accusamus voluptate quibusdam atque? Accusantium consequuntur porro quod vel deleniti fugiat voluptate? Dolores eligendi, odit perspiciatis fugit facilis tempore vero voluptates iste quaerat eos. Aliquid quibusdam suscipit eligendi nemo accusantium iste vero, dicta iusto, labore necessitatibus, alias dignissimos adipisci molestiae nobis dolores ab dolore autem. Tempore adipisci cupiditate, quisquam distinctio repellat facere, autem aliquid natus expedita obcaecati quae nostrum eaque temporibus?</textarea>
              </div>
            </div>
          </div>
        </div>
