    ...
    <main class="content">
      ...
      <div class="d-flex justify-content-between">
        <section class="title-content p-3">
          <h3><?= $title ?></h3>
          <p>Check documentation <a href="https://ckeditor.com/docs/ckeditor5/latest/installation/index.html" target="_blank">CKEditor</a></p>
        </section>
      ...
      <section class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">CKEditor Example</div>
              <div class="card-body">
                <!-- CKEditor here -->
                <div id="editor">
                  ...
                  <figure class="image image-style-side"><img src="<?= base_url('assets/modules/ckeditor/sample/img/umbrellas.jpg') ?>" alt="Three Monks walking on ancient temple.">
