...
<html lang="en" data-bs-theme="light">
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/modules/select2/css/select2-bootstrap-theme.min.css') ?>" />
    <!-- External CSS -->
    ...
    <main class="content">
      ...
      <div class="d-flex justify-content-between">
        <section class="title-content p-3">
          <h3><?= $title ?></h3>
          <p>Check documentation  <a href="https://select2.org/getting-started/installation" target="_blank">select2</a></p>
        </section>
      ...
      <section class="container-fluid">
        ...
        <!-- Basic Select2 Multi-select Example -->
        <div class="row mb-3">
          <div class="col-12">
            <div class="card">
