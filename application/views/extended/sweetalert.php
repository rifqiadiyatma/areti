    ...
    <nav class="sidebar offcanvas-md offcanvas-start" id="style-1" data-bs-scroll="true" data-bs-backdrop="false">
      ...
      <div class="pt-2 d-flex flex-column gap-5 mx-2">
        <div class="menu p-0">
          ...
          <a href="<?= base_url('form') ?>" class="item-menu">
      ...
      <section class="container-fluid">
        <div class="row">
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">
                <button class="btn btn-outline-primary rounded-4" id="sa-basic">Basic Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">    
                <button class="btn btn-outline-primary rounded-4" id="sa-success">Success Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">   
                <button class="btn btn-outline-primary rounded-4" id="sa-title">Title Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">
                <button class="btn btn-outline-primary rounded-4" id="sa-question">Question Sweetalert</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">
                <button class="btn btn-outline-primary rounded-4" id="sa-footer">Footer Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">    
                <button class="btn btn-outline-primary rounded-4" id="sa-error">Error Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">   
                <button class="btn btn-outline-primary rounded-4" id="sa-info">Info Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">
                <button class="btn btn-outline-primary rounded-4" id="sa-warning">Warning Sweetalert</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">
                <button class="btn btn-outline-primary rounded-4" id="sa-threebuttons">3 Buttons Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">    
                <button class="btn btn-outline-primary rounded-4" id="sa-deleteconfirm">Delete Confirm Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">   
                <button class="btn btn-outline-primary rounded-4" id="sa-bsdeleteconfirm">BS Delete Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">
                <button class="btn btn-outline-primary rounded-4" id="sa-inputemail">Email Sweetalert</button>
              </div>
            </div>
          </div>
        </div>
