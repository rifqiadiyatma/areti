...
<html lang="en" data-bs-theme="light">
  ...
  <body>
    ...
    <main class="content">
      ...
      <div class="d-flex justify-content-between">
        <section class="title-content p-3">
          <h3><?= $title ?></h3>
          <p>Check documentation <a href="https://sweetalert2.github.io/" target="_blanks">sweetalert</a></p>
        </section>
      ...
      <section class="container-fluid">
        <div class="row">
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">
                <button class="btn btn-primary rounded-4" id="sa-basic">Basic Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">    
                <button class="btn btn-primary rounded-4" id="sa-success">Success Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">   
                <button class="btn btn-primary rounded-4" id="sa-title">Title Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">
                <button class="btn btn-primary rounded-4" id="sa-question">Question Sweetalert</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">
                <button class="btn btn-primary rounded-4" id="sa-footer">Footer Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">    
                <button class="btn btn-primary rounded-4" id="sa-error">Error Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">   
                <button class="btn btn-primary rounded-4" id="sa-info">Info Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">
                <button class="btn btn-primary rounded-4" id="sa-warning">Warning Sweetalert</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">
                <button class="btn btn-primary rounded-4" id="sa-threebuttons">3 Buttons Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card bg-body-primary text-center">
              <div class="card-body">    
                <button class="btn btn-primary rounded-4" id="sa-deleteconfirm">Delete Confirm Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">   
                <button class="btn btn-primary rounded-4" id="sa-bsdeleteconfirm">BS Delete Sweetalert</button>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="card text-center">
              <div class="card-body">
                <button class="btn btn-primary rounded-4" id="sa-inputemail">Email Sweetalert</button>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- Sweet Alert -->
    <script src="<?= base_url('assets/modules/sweetalert/sweetalert2.js') ?>"></script>
