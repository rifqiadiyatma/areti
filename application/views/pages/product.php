...
<html lang="en" data-bs-theme="light">
  ...
  <body>
        ...
        <div class="row mb-3">
          <div class="col-12">
            <div class="card shadow">
              ...
              <div class="card-body">
                <div class="btn-group">
                  <a href="#" class="btn btn-primary btn-sm me-2 shadow">All</a>
                  <a class="btn btn-outline-primary btn-sm me-2 shadow">Delivered</a>
                  <a href="#" class="btn btn-outline-primary btn-sm me-2 shadow">Pick up</a>
                  <a href="#" class="btn btn-outline-primary btn-sm me-2 shadow">Failed</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-12">
            <div class="card shadow">
              <div class="card-header d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> Tambah</button>
              </div>
              <div class="card-body">
                  ...
                  <table id="myTable" class="table table-hover table-bordered">
                    ...
                    <tbody class="align-middle">
                      <tr>
                        ...
                        <td>
                          <div class="hstack gap-2">
                            <img src="<?= base_url('assets/images/avatar.jpg') ?>" class="user-img" alt="">
                            Jokowi
                          </div>
                        </td>
                        <td>
                          <span class="badge text-bg-success fw-normal">Delivered</span>
                        </td>
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-primary btn-sm rounded-3 me-1" href="#"><i class="fa-solid fa-eye"></i></a>
                            <a class="btn btn-success btn-sm rounded-3 me-1" href="#"><i class="fa-solid fa-check"></i></a>
                            <a class="btn btn-danger btn-sm rounded-3 me-1" href="#"><i class="fa-solid fa-trash"></i></a>
                          </div>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="badge text-bg-danger fw-normal">Failed</span>
                        </td>
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-primary btn-sm rounded-3 me-1" href="#"><i class="fa-solid fa-eye"></i></a>
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="badge text-bg-primary fw-normal">Pick up</span>
                        </td>
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-primary btn-sm rounded-3 me-1" href="#"><i class="fa-solid fa-eye"></i></a>
    ...
    <script src="<?= base_url('assets/modules/datatables/js/dataTables.bootstrap5.min.js') ?>"></script>
    <script>
      $(function () {
          $('#myTable').DataTable({
          columnDefs: [
