          ...
          <div class="col-lg-3 col-12 mb-3">
            <div class="card shadow text-center">
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                      <img src="<?= base_url('assets/images/avatar.jpg') ?>" class="img-fluid rounded-pill mb-3" width="250px"  alt="">
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
                    <button type="button" class="btn btn-primary btn-sm rounded-5">Change Picture</button>
                  </div>
                </div>
              </div>
            </div>
