  ...
  <body>
    ...
    <main class="content">
      ...
      <section class="title-content p-3">
        <h3><?= $title ?></h3>
        <p>Check documentation <a href="https://getbootstrap.com/docs/5.3/components/alerts/" target="_blank">alerts</a></p>
      </section>
      <section class="container-fluid">
        ...
        <div class="row mb-3">
          <!-- Alert with close buttons -->
          <div class="col-12 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="card-title mb-3">
                  <h5>Alerts with close buttons</h5>
                </div>
          ...
          <!-- Alerts with additionals -->
          <div class="col-12 col-md-6">
            <div class="card">
              <div class="card-body">
                <div class="card-title mb-3">
                  <h5>Alerts with additionals</h5>
                </div>
                <div class="alert alert-primary" role="alert">
