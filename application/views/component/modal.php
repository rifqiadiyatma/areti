  ...
  <body>
    ...
    <main class="content">
      ...
      <section class="container-fluid">
        <div class="row">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <!-- Button Modal Scrollable -->
              <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#exampleModalScrollable">
                Launch demo modal scrollable
              </button>
            </div>
          </div>
        </div>
        <div class="row mt-3">
          <div class="card">
            <div class="card-header">
              <h5>Modal Color Example</h5>
            </div>
            <div class="card-body">
              <!-- Button Modal Primary -->
              <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#exampleModalPrimary">
                Launch demo modal primary
              </button>
              <!-- Button Modal Success -->
              <button type="button" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#exampleModalSuccess">
                Launch demo modal success
              </button>
              <!-- Button Modal Danger -->
              <button type="button" class="btn btn-danger mb-3" data-bs-toggle="modal" data-bs-target="#exampleModalDanger">
                Launch demo modal danger
              </button>
            </div>
            <div class="card-footer">
              <p>Check other color in bootstrap <a href="https://getbootstrap.com/docs/5.3/components/modal/" target="_blank">documentation</a></p>
            </div>
          </div>
        </div>
        <div class="row mt-3">
          <div class="card">
            <div class="card-header">
              <h5>Modal Size Example</h5>
            </div>
            <div class="card-body">
              <!-- Button Extra Large Modal -->
              <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#exampleExtraLargeModal">
                Launch demo extra large modal
              </button>
              <!-- Button Large Modal -->
              <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#exampleLargeModal">
                Launch demo large modal
              </button>
              <!-- Button Small Modal -->
              <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#exampleSmallModal">
                Launch demo small modal
              </button>
              <!-- Button Full Screen Modal -->
              <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#exampleFullScreenModal">
                Launch demo Full Screen modal
              </button>
            </div>
          </div>
        </div>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalCenterLabel">Modal title</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            Content Here...
    ...
    <div class="modal fade" id="exampleModalScrollable" tabindex="-1" aria-labelledby="exampleModalScrollableLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalScrollableLabel">Modal title</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            Content Here...<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br> end content
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button type="button" class="btn btn-primary">Save changes</button>
    ...
    <!-- Modal Primary -->
    <div class="modal fade" id="exampleModalPrimary" tabindex="-1" aria-labelledby="exampleModalPrimaryLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content bg-primary">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalPrimaryLabel">Modal title</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            Content Here...
    ...
    <div class="modal fade" id="exampleModalSuccess" tabindex="-1" aria-labelledby="exampleModalSuccessLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content bg-success">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalSuccessLabel">Modal title</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            Content Here...
    ...
    <!-- Modal Danger -->
    <div class="modal fade" id="exampleModalDanger" tabindex="-1" aria-labelledby="exampleModalDangerLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content bg-danger">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalDangerLabel">Modal title</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            Content Here...
    ...
    <!-- Modal Extra Large -->
    <div class="modal fade" id="exampleExtraLargeModal" tabindex="-1" aria-labelledby="exampleExtraLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleExtraLargeModalLabel">Modal title</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            Content Here...
    ...
    <div class="modal fade" id="exampleLargeModal" tabindex="-1" aria-labelledby="exampleLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleLargeModalLabel">Modal title</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            Content Here...
    ...
    <!-- Modal Small -->
    <div class="modal fade" id="exampleSmallModal" tabindex="-1" aria-labelledby="exampleSmallModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleSmallModalLabel">Modal title</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            Content Here...
    ...
    <!-- Modal Full Screen -->
    <div class="modal fade" id="exampleFullScreenModal" tabindex="-1" aria-labelledby="exampleFullScreenModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleFullScreenModalLabel">Modal title</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            Content Here...
