    ...
    <main class="content">
      ...
      <div class="d-flex justify-content-between">
        <section class="title-content p-3">
          <h3><?= $title ?></h3>
          <p>Check documentation <a href="https://getbootstrap.com/docs/5.3/components/tooltips/" target="_blank">tooltips</a></p>
        </section>
      ...
      <section class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">Tooltips Example</div>
              <div class="card-body">
                <!-- Tooltip on top -->
                <button type="button" class="btn btn-primary mb-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Tooltip on top">
                  Tooltip on top
                </button>
                <!-- Tooltip on right -->
                <button type="button" class="btn btn-primary mb-3" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Tooltip on right">
                  Tooltip on right
                </button>
                <!-- Tooltip on bottom -->
                <button type="button" class="btn btn-primary mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Tooltip on bottom">
                  Tooltip on bottom
                </button>
                <!-- Tooltip on left -->
                <button type="button" class="btn btn-primary mb-3" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Tooltip on left">
                  Tooltip on left
                </button>
                <!-- Tooltip disabled button -->
                <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip" data-bs-title="Disabled tooltip">
                  <button class="btn btn-primary mb-3" type="button" disabled>Disabled button</button>
                </span>
                <!-- Tooltip with HTML -->
                <button type="button" class="btn btn-primary mb-3" data-bs-toggle="tooltip" data-bs-html="true" data-bs-title="<em>Tooltip</em> <u>with</u> <b>HTML</b>">
                  Tooltip with HTML
                </button>
                <!-- Tooltip on link -->
                <a href="#" data-bs-toggle="tooltip" data-bs-title="Tooltip on link" class="ms-2 mb-3">Tooltip on link</a>
              </div>
            </div>
          </div>
        </div>
