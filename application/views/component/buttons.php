  ...
  <body>
    ...
    <main class="content">
      ...
      <section class="title-content p-3">
        <h3><?= $title ?></h3>
        <p>Check documentation <a href="https://getbootstrap.com/docs/5.3/components/buttons/" target="_blank">buttons</a></p>
      </section>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-bordered text-center align-middle caption-top">
                    <caption class="fw-bold">Buttons Example</caption>
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button type="button" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Primary</button>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <button type="button" class="btn btn-secondary"><i class="fa-solid fa-xmark"></i> Secondary</button>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <button type="button" class="btn btn-success"><i class="fa-solid fa-check"></i> Success</button>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <button type="button" class="btn btn-danger"><i class="fa-solid fa-trash"></i> Danger</button>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <button type="button" class="btn btn-warning"><i class="fa-solid fa-bell"></i> Warning</button>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <button type="button" class="btn btn-info"><i class="fa-solid fa-info"></i> Info</button>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <button type="button" class="btn btn-light"><i class="fa-solid fa-sun"></i> Light</button>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <button type="button" class="btn btn-dark"><i class="fa-solid fa-moon"></i> Dark</button>
                        </td>
                      </tr>
                    </tbody>
                  </table>
