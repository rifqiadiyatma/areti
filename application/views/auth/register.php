...
<body>
  <div class="container-fluid d-flex justify-content-center align-items-center vh-100 bg-body-tertiary" >
    <div class="row text-center">
      <div class="col p-4">
        <div class="card shadow-lg">
          <div class="card-header">
            <h1 class="fs-4 fw-bold text-primary">Register Page</h1>
          </div>
          <div class="card-body">
            ...
            <form>
              ...
              <div class="mb-4 text-start">
                ...
                <div class="input-group">
                  <div class="input-group-text"><i class="fa-solid fa-lock text-primary"></i></div>
                  <input type="repassword" class="form-control" id="repassword" placeholder="Masukkan Konfirmasi Password">
                </div>
              </div>
              <div class="d-grid">
      ...
      <p class="mt-3">Sudah memiliki akun? <a href="<?= base_url('auth/login') ?>" class="text-primary">login</a></p>
    </div>
  </div>
